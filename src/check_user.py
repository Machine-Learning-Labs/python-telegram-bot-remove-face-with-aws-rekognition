...
def echo(update, context):
    ...
    if has_enough_credits(user_id):
        ...
        context.bot.send_message(chat_id=update.effective_chat.id, text="Sorry, you don't have enough credits.")
...
def send_image(update, context):
    ...
    if has_enough_credits(user_id):
        remove_credit(user_id)
        context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('path/to/your/image.jpg', 'rb'))
    else:
        context.bot.send_message(chat_id=update.effective_chat.id, text="Sorry, you don't have enough credits.")
